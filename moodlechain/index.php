...
require_once($CFG->dirroot . '/grade/report/moodlechain/lib.php');
...
$PAGE->set_url(new moodle_url($CFG->wwwroot . '/grade/report/moodlechain/index.php', array('id' => $courseid)));
...
require_capability('gradereport/moodlechain:view', $context);
...
$report->pbarurl = new moodle_url('/grade/report/moodlechain/index.php', array('id' => $courseid));
...
// User search
$url = new moodle_url('/grade/report/moodlechain/index.php', array('id' => $course->id));
